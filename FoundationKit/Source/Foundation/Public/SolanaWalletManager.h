...
public:
	...
	const FApiAsyncTaskSubSystemPtr& GetAsyncTaskManager() const { return AsynTaskManager; }
	...
	const FApiAsyncTaskSubSystemPtr& GetAsynTaskManager();
	
private:

	FApiAsyncTaskSubSystemPtr AsynTaskManager;
