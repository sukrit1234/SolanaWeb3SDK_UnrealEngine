...
UCLASS(Config = Foundation, DefaultConfig, BlueprintType, meta = (DisplayName = "Solana Settings"))
...
public:
	...
	const FString& GetNetworkURL_Cpp() const;
	ESolanaNetwork GetNetwork_Cpp() const;
...
protected:
	...
	static FString EmptyNetworkUrl;
};